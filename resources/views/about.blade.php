...
<style>
  ...
  #aboutValues{  
    background: url("{{ asset(App\Models\additionalImage::find(2)->link )}}") center center no-repeat;
  ...
  <div class="container  " data-aos="fade-up">
    <div class="row  ">
      <div class=" col-12 col-md-8 text-justify">
        ...
        <p>
          BeSkilled is here to provide scopes to the various segments of the people of the country to take the opportunities by building a wide variety of skillset and build their lifelong career. Our courses and services offer a wide variety of skills so that people can develop their proper skillset.
        </p>
...
<section class="about2  ">
  <div class="container  " data-aos="fade-up">
    <div class="row  ">
      ...
      <div class="pt-4">
        BeSkilled is here to provide scopes to the various segments of the people of the country to take the opportunities by building a wide variety of skillset and build their lifelong career. Our courses and services offer a wide variety of skills so that people can develop their proper skillset to compete in the current global market and earn independently. As Bangladesh is an emerging nation in digital market place we the BeSkilled promises to provide immense opportunities to the potential e-learners to fulfill their dream. BeSkilled is here to offer a great learning platform for the learners from where they can eventually see themselves as powerful e-services holders and earn significant foreign currency for them and for the country.
      </div>
